    ...
    <section class="allnewss">
        ...
        <div class="allnewsdetails">
            ...
            <div class="right_newsdeta">
                ...
                <div class="icons_ns">
                    <div class="icon_n">
                        <svg id="Group_35" data-name="Group 35" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="27.954" viewBox="0 0 30 27.954">
                            <defs>
                    ...
                    <div class="icon_n">
                        <svg id="Group_37" data-name="Group 37" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="30.019" viewBox="0 0 30 30.019">
                            ...
                            <g id="Group_36" data-name="Group 36" clip-path="url(#clip-path)">
                                <path id="Path_143" data-name="Path 143" d="M30,14.988A15,15,0,1,1,15,0,15.031,15.031,0,0,1,30,14.988m-2.417.029A12.572,12.572,0,1,0,15.017,27.582,12.638,12.638,0,0,0,27.582,15.017" transform="translate(0 0)" fill="#0091de" />
                                <path id="Path_144" data-name="Path 144" d="M120.6,63.564c0,.934.016,1.868-.008,2.8a.955.955,0,0,0,.437.88c1.223.9,2.433,1.813,3.641,2.731a1.2,1.2,0,0,1,.538,1.318,1.224,1.224,0,0,1-.959.918,1.144,1.144,0,0,1-.986-.246q-2.3-1.7-4.579-3.425a1.249,1.249,0,0,1-.5-1.065c0-2.276-.005-4.552.006-6.827a1.2,1.2,0,1,1,2.406,0c.014.972,0,1.945,0,2.918Z" transform="translate(-104.382 -52.444)" fill="#0091de" />
                            </g>
                        </svg>
                        <p>{{ $event->created_at_event_time }}</p>
                    </div>
                    <div class="icon_n">
                        <svg id="Group_38" class="po" data-name="Group 38" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20.547" height="30.764" viewBox="0 0 20.547 30.764">
                            <defs>
                                <clipPath id="clip-path">
                ...
                <div class="img_news">
                    ...
                    <div class="sotial_news">
                        <a href="">
                            <div class="shersotio">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="17.979" height="19.58" viewBox="0 0 17.979 19.58">
                                    <defs>
                                        <clipPath id="clip-path">
            ...
            <div class="left_newsdeta">
                ...
                <div class="allcnew">
                    ...
                    <div class="lastnews">
                        <div class="imglnews">
                            <img width="150" height="90" src="{{ asset('storage/' . $event->cover_image) }}" alt="">
                        </div>
                        <div class="textlnews">
                            ...
                            <div class="nononews">
                                <svg id="Group_37" data-name="Group 37" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="16.477" height="16.487" viewBox="0 0 16.477 16.487">
                                    <defs>
                                        <clipPath id="clip-path">
                                    ...
                                    <g id="Group_36" data-name="Group 36" clip-path="url(#clip-path)">
                                        <path id="Path_143" data-name="Path 143" d="M16.476,8.232A8.238,8.238,0,1,1,8.24,0a8.256,8.256,0,0,1,8.236,8.232m-1.327.016a6.905,6.905,0,1,0-6.9,6.9,6.941,6.941,0,0,0,6.9-6.9" transform="translate(0 0)" fill="#0091de" />
                                        <path id="Path_144" data-name="Path 144" d="M119.511,61.677c0,.513.009,1.026,0,1.538a.524.524,0,0,0,.24.483c.672.493,1.336,1,2,1.5a.659.659,0,0,1,.3.724.672.672,0,0,1-.527.5.628.628,0,0,1-.541-.135q-1.261-.935-2.515-1.881a.686.686,0,0,1-.275-.585c0-1.25,0-2.5,0-3.75a.662.662,0,1,1,1.322,0c.008.534,0,1.068,0,1.6Z" transform="translate(-110.603 -55.57)" fill="#0091de" />
                                    </g>
                                </svg>
                                <p>{{ $event->created_at_event_time }}
                                </p>
                            </div>
                        </div>
                    </div>
